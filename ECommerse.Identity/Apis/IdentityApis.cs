using ECommerse.Identity.Dtos;

namespace ECommerse.Identity.Apis;

public static class IdentityApis
{
    private static readonly EmailAddressAttribute _emailAddressAttribute = new();

    public static IEndpointConventionBuilder AddIdentityEndpoints<TUser>(this IEndpointRouteBuilder endpoints) where TUser : class, new()
    {
            ...
            ([FromBody] RegisterDto registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(AddIdentityEndpoints)} requires a user store with email support.");
            }
            ...
            IUserPhoneNumberStore<TUser> phoneStore = (IUserPhoneNumberStore<TUser>)userStore;
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(AddIdentityEndpoints)}-{finalPattern}";
